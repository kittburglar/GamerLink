...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        RelativeLayout lblListHeader = (RelativeLayout) convertView
        ...
        TextView textHeader2 = (TextView) convertView.findViewById(R.id.lblListHeader2);
        textHeader2.setText("Popular Games");
